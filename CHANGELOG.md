...
* Add tracking for suggested application name click event [Rahul Thakoor]

# v6.7.0
## (2023-05-03)

* Adds flash application event [Otávio Jacobi]
...
* Adds createNewClicked and addNewClicked events [Otávio Jacobi]

# v6.4.0
## (2023-02-02)

* Adds applicationName.set and applicationDeviceType.select events [Otávio Jacobi]

# v6.3.1
## (2022-11-30)

* Stops reporting to google analytics [Otávio Jacobi]
...
* Add Changelog click event [Matthew Yarmolinsky]
